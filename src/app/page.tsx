...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-b ${config.themeColor.bgGradient} flex flex-col justify-between overflow-x-hidden`}>
      ...
      {/* Header */}
      <header className="border-b border-white/10 backdrop-blur-md sticky top-0 z-50 bg-slate-950/75">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6 text-sm font-medium text-slate-300">
            <span className="hover:text-white transition-colors cursor-pointer">Dropshipping</span>
            <span className="hover:text-white transition-colors cursor-pointer">E-commerce</span>
            <span className="hover:text-white transition-colors cursor-pointer">Facebook Ads</span>
            <span className="hover:text-white transition-colors cursor-pointer">Digital Marketing</span>
          </div>
          <div>
            <a
              href="#capture-form"
              className={`text-xs sm:text-sm font-semibold text-white px-4 py-2.5 rounded-full ${config.themeColor.primary} ${config.themeColor.primaryHover} transition-all duration-300 shadow-lg shadow-blue-500/20`}
            >
              Get Consultation
            </a>
          </div>
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs sm:text-sm text-blue-400 font-medium">
          ...
          <div className="pt-4 space-y-3">
            {config.features.map((feature, idx) => (
              <div key={idx} className="flex items-start gap-3">
                ...
                <span className="text-sm sm:text-base text-slate-200">{feature}</span>
              </div>
            ))}
          </div>
          ...
          <div className="pt-6 grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-white/10">
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              <ShoppingBag className="w-6 h-6 text-blue-400 mb-1" />
              <span className="text-xs text-slate-400">Dropshipping</span>
            </div>
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              <Target className="w-6 h-6 text-indigo-400 mb-1" />
              <span className="text-xs text-slate-400">Facebook Ads</span>
            </div>
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
              <CheckCircle2 className="w-6 h-6 text-amber-400 mb-1" />
              <span className="text-xs text-slate-400">ROI-Focused</span>
            </div>
          </div>
        </div>
        ...
        <div id="capture-form" className="lg:col-span-5">
          <div className="relative bg-slate-900/60 border border-white/10 rounded-2xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl space-y-6">
            <div className="absolute -top-4 -right-4 bg-emerald-500 text-slate-950 font-bold text-xs uppercase px-3 py-1 rounded-full shadow-lg">
              Limited Slots
            </div>

            <div className="space-y-2">
              <h3 className="text-xl sm:text-2xl font-bold text-white">Let's Skyrocket Your Sales</h3>
      ...
      <section className="bg-slate-950/40 border-t border-white/5 py-12">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                <p className="text-2xl sm:text-3xl font-extrabold text-blue-400">4.8x</p>
                <p className="text-xs text-slate-400">Average Facebook Ad ROAS</p>
              </div>
              <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                <p className="text-2xl sm:text-3xl font-extrabold text-emerald-400">$12M+</p>
                <p className="text-xs text-slate-400">Client Revenue Generated</p>
              </div>
            </div>
          </div>

          {/* Main Visual Image (image.png) */}
          <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-slate-900 aspect-video flex items-center justify-center">
            <img
              src={config.imageUrl}
